...
if &encoding == s:save_encoding
  let no_b = ''
  let no_b = no_b . "¡ñ ¡ë ¡Ç ¡É ¢ó ¡ì ¡í ¡î ¡¢ ¡£ ¡¹ ¡Ó ¡Õ ¡× ¡Ù ¡Û ¡Í "
  let no_b = no_b . "¤¡ ¤£ ¤¥ ¤§ ¤© ¤Ã ¤ã ¤å ¤ç ¤î ¡« ¡¬ ¡µ ¡¶ "
  let no_b = no_b . "¥¡ ¥£ ¥¥ ¥§ ¥© ¥Ã ¥ã ¥å ¥ç ¥î ¥õ ¥ö "
  let no_b = no_b . "¡¦ ¡¼ ¡³ ¡´ ¡ª ¡ó ¡Ë ¡¤ ¡¥ ¡§ ¡¨ ¡© ¡Ï ¡Ñ ¡Ä ¡Á "

  let no_e = ''
  let no_e = no_e . "¡ò ¡Æ ¡È ¡Ò ¡Ô ¡Ö ¡Ø ¡Ú ¡Ì ¡ð ¡Ê ¡Î ¡Ð ¡ï "
